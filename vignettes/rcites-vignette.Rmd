...
`spp_distributions()` and map it with the help of the
`rworldmap` package:

```{R map, eval = FALSE, message = FALSE, fig.width = 6.4, fig.height = 7.6, fig.align="center"}
par(las = 1)
suppressPackageStartupMessages(library(rworldmap))
map1 <- as.data.frame(spp_distributions("4521"))
...
```{r}
ref2 <- spp_references(taxon_id = "3210")
