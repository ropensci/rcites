...
```
#>  $names
#>  [1] "all_id"         "general"        "higher_taxa"    "accepted_names" "common_names"  
#>  [6] "synonyms"       "cites_listings"
#>  
#>  $class
#>  [1] "spp_taxon"
#>  
...
#>    id    full_name           author_year    rank  name_status updated_at          active cites_listing
#>  * <chr> <chr>               <chr>          <chr> <chr>       <dttm>              <lgl>  <chr>        
#>  1 3210  Amazilia versicolor (Vieillot, 18… SPEC… A           2015-05-07 15:10:59 TRUE   II
```
