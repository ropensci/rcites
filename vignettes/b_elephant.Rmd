...
#>  1 4521  Loxodonta africana (Blumenbach, 1… SPEC… A           2021-10-13 13:12:58 TRUE   I/II         
#>  
...
#>  # A tibble: 10 × 10
#>     id    taxon_concept_id quota publication_date public_display is_current unit  geo_entity.iso_code2
#>     <chr> <chr>            <chr> <chr>            <lgl>          <lgl>      <chr> <chr>               
#>   1 25337 4521             0     2021-02-03       TRUE           TRUE       <NA>  KE                  
#>   2 25348 4521             0     2021-02-03       TRUE           TRUE       <NA>  LR                  
#>   3 25355 4521             0     2021-02-03       TRUE           TRUE       <NA>  MW                  
#>   4 25358 4521             0     2021-02-03       TRUE           TRUE       <NA>  ML                  
#>   5 25375 4521             0     2021-02-03       TRUE           TRUE       <NA>  MZ                  
#>   6 25390 4521             0     2021-02-03       TRUE           TRUE       <NA>  AO                  
#>   7 25414 4521             0     2021-02-03       TRUE           TRUE       <NA>  NE                  
#>   8 25431 4521             0     2021-02-03       TRUE           TRUE       <NA>  NG                  
#>   9 25554 4521             100   2021-02-03       TRUE           TRUE       <NA>  TZ                  
#>  10 25555 4521             300   2021-02-03       TRUE           TRUE       <NA>  ZA                  
#>  # … with 2 more variables: geo_entity.name <chr>, geo_entity.type <chr>
#>  -------truncated-------
#>  Field(s) not printed:  notes, url 
#>  
#>  ── Cites suspensions ($cites_suspensions): ──────────────────────────────────────────────────────────
#>  # A tibble: 10 × 8
#>     id    taxon_concept_id start_date is_current applies_to_import geo_entity.iso_c… geo_entity.name  
#>     <chr> <chr>            <chr>      <lgl>      <lgl>             <chr>             <chr>            
#>   1 17621 4521             2014-08-11 TRUE       TRUE              US                United States of…
#>   2 17620 4521             2014-08-11 TRUE       TRUE              US                United States of…
#>   3 17686 4521             2014-10-10 TRUE       TRUE              US                United States of…
#>   4 18709 4521             2010-08-16 TRUE       TRUE              ZW                Zimbabwe         
#>   5 15983 <NA>             2011-01-19 TRUE       FALSE             DJ                Djibouti         
#>   6 22079 <NA>             2018-01-30 TRUE       FALSE             DJ                Djibouti         
#>   7 22076 <NA>             2018-01-22 TRUE       FALSE             LR                Liberia          
#>   8 22132 4521             2018-03-19 TRUE       FALSE             AU                Australia        
#>   9 23168 <NA>             2019-07-04 TRUE       FALSE             SO                Somalia          
#>  10 24947 4521             2020-05-26 TRUE       TRUE              CN                China            
...
#>  # A tibble: 10 × 15
#>     id    taxon_concept_id start_date is_current eu_decision_type.… eu_decision_type… geo_entity.iso_…
#>     <chr> <chr>            <chr>      <lgl>      <chr>              <chr>             <chr>           
#>   1 26285 4521             2015-04-09 TRUE       Positive           POSITIVE_OPINION  ZW              
#>   2 25508 4521             2014-09-03 TRUE       Positive           POSITIVE_OPINION  BW              
#>   3 11682 4521             2012-02-23 TRUE       Positive           POSITIVE_OPINION  NA              
#>   4 24825 4521             2014-05-28 TRUE       Positive           POSITIVE_OPINION  ZA              
#>   5 27017 4521             2015-09-15 TRUE       Positive           POSITIVE_OPINION  ZM              
#>   6 27360 4521             2016-06-27 TRUE       Negative           NEGATIVE_OPINION  MZ              
#>   7 35567 4521             2020-03-03 TRUE       <NA>               <NA>              MZ              
#>   8 30377 4521             2017-06-21 TRUE       Negative           NEGATIVE_OPINION  TZ              
#>   9 30553 4521             2017-06-21 TRUE       Positive           POSITIVE_OPINION  TZ              
#>  10 32143 4521             2019-10-17 TRUE       Suspension (a)     SUSPENSION        CM              
#>  # … with 8 more variables: geo_entity.name <chr>, geo_entity.type <chr>, start_event.name <chr>,
#>  #   start_event.date <chr>, source.code <chr>, source.name <chr>, term.code <chr>, term.name <chr>
