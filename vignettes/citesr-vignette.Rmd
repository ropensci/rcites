...
is required. To obtain a token, the user must sign up on the
[Species+/CITES API website](http://api.speciesplus.net/users/sign_up).
Below, we assume that the user already possesses a token and we assume that
its value is `8QW6Qgh57sBG2k0gtt` as on the API documentation see
...
![Figure 1](img/sppplus_login.png){width="80%"}
