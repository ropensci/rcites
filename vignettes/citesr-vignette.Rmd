...
<<<<<<< HEAD
Below, we assume that the user already possesses a token. For iluastrative purposes
we will use the generic token value `8QW6Qgh57sBG2k0gtt` just as on the API
documentation, but each user should obtain it's own token to run the code below (see
=======
Below, we assume that the user already possesses a token. For iluastrative purposes  we will use the generic token value `8QW6Qgh57sBG2*****` just as on the API documentation, but each user should obtain it's own token to run the code below (see
>>>>>>> master
