...
#' @return If appendix_only is TRUE, returns a dataframe with species' taxon id and CITES appendix information. If appendix_only is FALSE, returns a list with all Species+ taxon concept information.
#'
